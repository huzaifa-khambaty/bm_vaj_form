...
class ControllerCommonFileManager extends Controller {
    ...
    public function image() {
        ...
        } elseif (isset($this->request->get['image'])) {
            $this->response->setOutput($this->model_tool_image->resize($this->request->get['image'], 100, 100));
        }
    }
    ...
    public function create() {
        ...
        if (!$this->user->hasPermission('update', 'common/filemanager')) {
