...
//        $this->ln(30);
        ...
        $this->SetFont('times', 'B', 16);
        $this->Cell(445, 20, '1. Amount to be given vide Pay Order or Cheque in the name of ', 0, 0, 'L');
        ...
        $this->ln(20);
        $this->Cell(60,20,'');
        $this->Cell(300, 20, '4. No Cash Transactions', 0, 0, 'L');

        $this->ln(20);
        $this->Cell(60,20,'');
        $this->Cell(300, 20, '5. Signature on Form is mandatory along with instrument details.', 0, 0, 'L');
    }
}
