...
class ControllerSetupTakmeenReport extends HController {

    protected function getAlias() {
        return 'setup/takmeen_report';
    }
    ...
    public function printReport() {
        ...
        $this->model['takmeen_report'] = $this->load->model('setup/takmeen_report');
        $arrFilter = [];
        ...
        foreach($rows as $row) {
            ...
            $pdf->Cell(20,5,$row['sf_no'],1,0,'C');
            $pdf->Cell(100,5,$row['full_name'],1,0,'L');
            $pdf->Cell(15,5,'Yes',1,0,'C');
            $pdf->ln(5);
        }
...
//        $this->Cell(180,5,'',1,0,'L');
        ...
        $this->Cell(20,5,'SF#',1,0,'C');
        $this->Cell(100,5,'Name',1,0,'C');
        $this->Cell(15,5,'Takhmeen',1,0,'C');
    }
