                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="to_date" name="to_date" value="<?php echo $to_date; ?>" class="form-control dtpDate" tabindex="2" />
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                                <label><?php echo $entry_from_amount; ?></label>
                                <input type="text" id="from_amount" name="from_amount" value="" class="form-control" tabindex="3" />
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                                <label><?php echo $entry_to_amount; ?></label>
                                <input type="text" id="to_amount" name="to_amount" value="" class="form-control" tabindex="4" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select id="mohallah_id" name="mohallah_id" class="form-control" tabindex="5">
                                    <option value="">&nbsp;</option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select id="user_id" name="user_id" class="form-control" tabindex="6">
                                    <option value="">&nbsp;</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select id="sort_order" name="sort_order" class="form-control" tabindex="7">
...
<script>
    var $href_get_mohallah_users = '<?php echo $href_get_mohallah_users; ?>';
    $('#mohallah_id').bind('change', function() {
        var $mohallah_id = $(this).val();

        $.ajax({
            url: $href_get_mohallah_users,
            dataType: 'json',
            type: 'post',
            data: 'mohallah_id=' + $mohallah_id,
            success: function(json) {
                if(json.success) {
                    $('#user_id').html(json.html);
                } else {
                    console.log(json);
                }
            },
    ...
    function printReport() {
        ...
        var $URL = $URLPrintReport + '&from_date='+ $from_date + '&to_date='+ $to_date + '&from_amount='+ $from_amount + '&to_amount='+ $to_amount + '&user_id='+$user_id + '&mohallah_id='+$mohallah_id + '&sort_order='+$sort_order;
