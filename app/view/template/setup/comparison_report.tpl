                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select id="sort_order" name="sort_order" class="form-control" tabindex="6">
...
<script>
    ...
    function printReport() {
        ...
        var $URL = $URLPrintReport + '&from_date='+ $from_date + '&to_date='+ $to_date + '&from_amount='+ $from_amount + '&to_amount='+ $to_amount + '&mohallah_id='+$mohallah_id + '&sort_order='+$sort_order;
